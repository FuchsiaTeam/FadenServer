...
public class FadenBuildingBlocks {
    ...
    public static Block registerBlock(String name, Block block, DataToolType toolType, DataToolTier tier, DataBlockType blockType) {
        return registerBlock(name, block, null, toolType, tier, blockType, true, true);
    }

    public static Block registerBlock(String name, Block block, DataBlockType blockType) {
        return registerBlock(name, block, null, DataToolType.NONE, DataToolTier.NONE,  blockType, true, true);
    }

    public static Block registerBlock(String name, Block block, DataToolType toolType, DataBlockType blockType) {
        return registerBlock(name, block, null, toolType, DataToolTier.NONE,  blockType, true, true);
    }

    public static Block registerBlock(String name, Block block, DataBlockType blockType, boolean dropSelf) {
        return registerBlock(name, block, null, DataToolType.NONE, DataToolTier.NONE,  blockType, dropSelf, true);
    }

    public static Block registerBlock(String name, Block block, DataToolType toolType, DataBlockType blockType, boolean dropSelf) {
